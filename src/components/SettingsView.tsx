...
const SETTING_LABELS: Record<string, { name: string; desc: string; type: string; options?: string[] }> = {
  ...
  defaultOsTemplate: { name: 'Шаблон ОС по умолчанию', desc: 'Шаблон для быстрого развёртывания', type: 'select', options: ['ubuntu', 'debian', 'kali', 'alpine', 'windows-xp', 'windows-7', 'windows-8', 'windows-10', 'windows-11'] },
